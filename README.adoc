...
Starting with the Eureka-enabled "hello world" example from link:/gs-service-registry[Registering and Discovering Services], you'll start by adding a circuit breaker to the client code.
